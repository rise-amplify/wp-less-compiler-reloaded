			...
			<form method="post" enctype="multipart/form-data" class="padded-form bordered-form options-form">
				...
				<div class="form-row">
					<div class="form12">
						...
						<input type="text" name="less[url]" id="less_url" value="<?php echo esc_attr( $this->less->url ); ?>" readonly="readonly" />
						<input type="hidden" name="less[path]" id="less_file" value="<?php echo esc_attr( $this->less->path ); ?>">
					</div>
					<div class="form4 no-label">
						<a class="file-browser button centered-label" href="#" data-path="<?php echo esc_attr( self::$template_path ); ?>" data-url="<?php echo esc_attr( self::$template_url ); ?>" data-linked-url-field="#less_url" data-linked-path-field="#less_file">Browse for File</a>
					</div>
				</div>
				...
				<div class="form-row">
					<div class="form12">
						...
						<input type="text" name="css[url]" id="css_url" value="<?php echo esc_attr( $this->css->url ); ?>" readonly="readonly" />
						<input type="hidden" name="css[path]" id="css_file" value="<?php echo esc_attr( $this->css->path ); ?>">
					</div>
					<div class="form4 no-label">		
						<a class="file-browser button centered-label" href="#" data-path="<?php echo esc_attr( self::$template_path ); ?>" data-url="<?php echo esc_attr( self::$template_url ); ?>" data-linked-url-field="#css_url" data-linked-path-field="#css_file">Browse for File</a>
					</div>
				</div>
